...
const ProjectNum = () => {
  return (
    <div className="hover:-translate-y-2 group  duration-500 w-44 h-44 flex text-neutral-600 flex-col justify-center items-center relative rounded-xl overflow-hidden">
      <svg
        viewBox="0 0 200 200"
