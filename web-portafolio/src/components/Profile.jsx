...
const Profile = () => {
  return (
    <div className="relative flex w-full max-w-6xl h-[300px] mx-auto bg-white text-black dark:bg-[#0a192f] dark:text-white">
      ...
      <div className="flex bg-[#0a192f] flex-col flex-1 mt-12 md:mt-0 overflow-hidden">
